class DataTable {
    ...
    createHTML() {
        this.element.innerHTML = `
        <div class="tabContainer-orders">
        <table  class="datatable-orders">
          <thead>
            <tr>
            </tr>
          </thead>
        ...
        <div class="footer-orders">
            <i class="btn-share fas fa-share-alt"></i>
    ...
    renderPagesButtons() {
        const pagesContainer = this.element.querySelector('.pages-orders');
        let pages = '';
        ...
        this.element.querySelectorAll('.pages-orders li button').forEach(button => {
    ...
    renderFooterButtons() {
        let html = '';
        const buttonsContainer = this.element.querySelectorAll('.footer-orders');
